            ...
            <div id="main_layout" class="col-xs-8">
                <form method="post" >
                    <div id="sql-view" class="sql_view row">
                        ...
                        <textarea name="query[DEL_D]" style="display: none;"><?php echo $delete_d; ?></textarea>
                        ...
                        <textarea name="query[DEL_E]" style="display: none;"><?php echo $delete_e; ?></textarea>
                        ...
                        <?php if(isset($show_f)){?>
                        <H5><b>F:不備電話</b></H5>
                        <textarea name="query[DEL_F]" style="display: none;"><?php echo $delete_f; ?></textarea>
                        ...
                        <textarea name="query[DEL_G]" style="display: none;"><?php echo $delete_g; ?></textarea>
                        ...
                        <textarea name="query[DEL_H]" style="display: none;"><?php echo $delete_h; ?></textarea>
                        ...
                        if(empty($block_arr)){
                            echo '<textarea id="dl_sql" name="query[DL]" >'.$dl_sql.'</textarea>';
                        }
                        ?>
                    </div>
                    <div class="row">
